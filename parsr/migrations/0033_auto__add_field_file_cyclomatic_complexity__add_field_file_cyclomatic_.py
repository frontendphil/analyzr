...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.cyclomatic_complexity'
        db.add_column(u'parsr_file', 'cyclomatic_complexity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'File.cyclomatic_complexity_delta'
        db.add_column(u'parsr_file', 'cyclomatic_complexity_delta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.cyclomatic_complexity'
        db.delete_column(u'parsr_file', 'cyclomatic_complexity')

        # Deleting field 'File.cyclomatic_complexity_delta'
        db.delete_column(u'parsr_file', 'cyclomatic_complexity_delta')
    ...
    models = {
        ...
        u'parsr.file': {
            ...
            'cyclomatic_complexity': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'cyclomatic_complexity_delta': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
