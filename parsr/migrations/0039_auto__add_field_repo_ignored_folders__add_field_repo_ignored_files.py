...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repo.ignored_folders'
        db.add_column(u'parsr_repo', 'ignored_folders',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repo.ignored_files'
        db.add_column(u'parsr_repo', 'ignored_files',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repo.ignored_folders'
        db.delete_column(u'parsr_repo', 'ignored_folders')

        # Deleting field 'Repo.ignored_files'
        db.delete_column(u'parsr_repo', 'ignored_files')
