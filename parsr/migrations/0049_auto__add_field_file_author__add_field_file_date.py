...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'parsr_file', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parsr.Author'], null=True),
                      keep_default=False)

        # Adding field 'File.date'
        db.add_column(u'parsr_file', 'date',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'parsr_file', 'author_id')

        # Deleting field 'File.date'
        db.delete_column(u'parsr_file', 'date')
