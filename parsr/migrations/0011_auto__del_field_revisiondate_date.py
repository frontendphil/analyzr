...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RevisionDate.date'
        db.delete_column(u'parsr_revisiondate', 'date')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RevisionDate.date'
        raise RuntimeError("Cannot reverse this migration. 'RevisionDate.date' and its values cannot be restored.")
