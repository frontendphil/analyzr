...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Revision.next'
        db.add_column(u'parsr_revision', 'next',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parsr.Revision'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Revision.next'
        db.delete_column(u'parsr_revision', 'next_id')
