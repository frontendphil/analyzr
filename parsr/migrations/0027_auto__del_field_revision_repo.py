...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Revision.repo'
        db.delete_column(u'parsr_revision', 'repo_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Revision.repo'
        raise RuntimeError("Cannot reverse this migration. 'Revision.repo' and its values cannot be restored.")
