...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.halstead_volume_delta'
        db.add_column(u'parsr_file', 'halstead_volume_delta',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'File.halstead_difficulty_delta'
        db.add_column(u'parsr_file', 'halstead_difficulty_delta',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'File.halstead_effort_delta'
        db.add_column(u'parsr_file', 'halstead_effort_delta',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.halstead_volume_delta'
        db.delete_column(u'parsr_file', 'halstead_volume_delta')

        # Deleting field 'File.halstead_difficulty_delta'
        db.delete_column(u'parsr_file', 'halstead_difficulty_delta')

        # Deleting field 'File.halstead_effort_delta'
        db.delete_column(u'parsr_file', 'halstead_effort_delta')
    ...
    models = {
        ...
        u'parsr.file': {
            ...
            'cyclomatic_complexity': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'cyclomatic_complexity_delta': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'halstead_difficulty': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'halstead_difficulty_delta': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'halstead_effort': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'halstead_effort_delta': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'halstead_volume': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'halstead_volume_delta': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
