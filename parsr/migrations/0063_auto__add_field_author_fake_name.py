...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.fake_name'
        db.add_column(u'parsr_author', 'fake_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.fake_name'
        db.delete_column(u'parsr_author', 'fake_name')
    ...
    models = {
        u'parsr.author': {
            ...
            'fake_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
