...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Branch.revision_count'
        db.add_column(u'parsr_branch', 'revision_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Branch.revision_count'
        db.delete_column(u'parsr_branch', 'revision_count')
