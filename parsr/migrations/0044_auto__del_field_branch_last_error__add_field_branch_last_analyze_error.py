...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Branch.last_error'
        db.delete_column(u'parsr_branch', 'last_error')

        # Adding field 'Branch.last_analyze_error'
        db.add_column(u'parsr_branch', 'last_analyze_error',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Branch.last_measure_error'
        db.add_column(u'parsr_branch', 'last_measure_error',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Branch.last_error'
        db.add_column(u'parsr_branch', 'last_error',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Branch.last_analyze_error'
        db.delete_column(u'parsr_branch', 'last_analyze_error')

        # Deleting field 'Branch.last_measure_error'
        db.delete_column(u'parsr_branch', 'last_measure_error')
