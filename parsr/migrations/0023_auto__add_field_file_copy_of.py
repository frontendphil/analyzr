...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.copy_of'
        db.add_column(u'parsr_file', 'copy_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parsr.File'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.copy_of'
        db.delete_column(u'parsr_file', 'copy_of_id')
