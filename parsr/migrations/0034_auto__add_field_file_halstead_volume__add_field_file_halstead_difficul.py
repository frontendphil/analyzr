...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.halstead_volume'
        db.add_column(u'parsr_file', 'halstead_volume',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'File.halstead_difficulty'
        db.add_column(u'parsr_file', 'halstead_difficulty',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'File.halstead_effort'
        db.add_column(u'parsr_file', 'halstead_effort',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'File.halstead_volume'
        db.delete_column(u'parsr_file', 'halstead_volume')

        # Deleting field 'File.halstead_difficulty'
        db.delete_column(u'parsr_file', 'halstead_difficulty')

        # Deleting field 'File.halstead_effort'
        db.delete_column(u'parsr_file', 'halstead_effort')


        # Changing field 'File.cyclomatic_complexity'
        db.alter_column(u'parsr_file', 'cyclomatic_complexity', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'File.cyclomatic_complexity_delta'
        db.alter_column(u'parsr_file', 'cyclomatic_complexity_delta', self.gf('django.db.models.fields.IntegerField')())
