...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.branch'
        db.add_column(u'parsr_package', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parsr.Branch'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.branch'
        db.delete_column(u'parsr_package', 'branch_id')
