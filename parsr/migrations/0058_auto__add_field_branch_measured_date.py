...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Branch.measured_date'
        db.add_column(u'parsr_branch', 'measured_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Branch.measured_date'
        db.delete_column(u'parsr_branch', 'measured_date')
