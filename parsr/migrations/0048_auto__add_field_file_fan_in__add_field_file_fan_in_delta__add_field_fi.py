...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.fan_in'
        db.add_column(u'parsr_file', 'fan_in',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'File.fan_in_delta'
        db.add_column(u'parsr_file', 'fan_in_delta',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'File.fan_out'
        db.add_column(u'parsr_file', 'fan_out',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'File.fan_out_delta'
        db.add_column(u'parsr_file', 'fan_out_delta',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'File.sloc'
        db.add_column(u'parsr_file', 'sloc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'File.sloc_delta'
        db.add_column(u'parsr_file', 'sloc_delta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'File.hk'
        db.add_column(u'parsr_file', 'hk',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'File.hk_delta'
        db.add_column(u'parsr_file', 'hk_delta',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.fan_in'
        db.delete_column(u'parsr_file', 'fan_in')

        # Deleting field 'File.fan_in_delta'
        db.delete_column(u'parsr_file', 'fan_in_delta')

        # Deleting field 'File.fan_out'
        db.delete_column(u'parsr_file', 'fan_out')

        # Deleting field 'File.fan_out_delta'
        db.delete_column(u'parsr_file', 'fan_out_delta')

        # Deleting field 'File.sloc'
        db.delete_column(u'parsr_file', 'sloc')

        # Deleting field 'File.sloc_delta'
        db.delete_column(u'parsr_file', 'sloc_delta')

        # Deleting field 'File.hk'
        db.delete_column(u'parsr_file', 'hk')

        # Deleting field 'File.hk_delta'
        db.delete_column(u'parsr_file', 'hk_delta')
