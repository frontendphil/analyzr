...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RevisionDate.day_of_week'
        db.delete_column(u'parsr_revisiondate', 'day_of_week')

        # Deleting field 'RevisionDate.day_of_month'
        db.delete_column(u'parsr_revisiondate', 'day_of_month')


    def backwards(self, orm):
        # Adding field 'RevisionDate.day_of_week'
        db.add_column(u'parsr_revisiondate', 'day_of_week',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'RevisionDate.day_of_month'
        db.add_column(u'parsr_revisiondate', 'day_of_month',
